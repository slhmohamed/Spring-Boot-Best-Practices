...
import com.example.springbootbestpractices.dto.APIResponse;
...
public class ProductController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<APIResponse> updateProduct(@PathVariable Long id ,  @RequestBody @Valid ProductRequestDTO productRequestDTO) {

        log.info("ProductController::updateProduct request body {}", ValueMapper.jsonAsString(productRequestDTO));
        ...
        log.info("ProductController::updateProduct response {}", ValueMapper.jsonAsString(responseDTO));
